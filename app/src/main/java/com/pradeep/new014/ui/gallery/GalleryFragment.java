package com.pradeep.new014.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        ...
        myRecyclerView=(RecyclerView)root.findViewById(R.id.recycleviewGalary);
        myRecyclerView.setLayoutManager(new GridLayoutManager(getContext(),3));
        list = new ArrayList<Title>();
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("BooksName");
