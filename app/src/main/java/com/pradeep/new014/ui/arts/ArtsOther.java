package com.pradeep.new014.ui.arts;
...
public class ArtsOther extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_arts_other, container, false);
        myRecyclerView=(RecyclerView)root.findViewById(R.id.recycleviewArts);
        myRecyclerView.setLayoutManager(new GridLayoutManager(getContext(),3));
        list = new ArrayList<Title>();
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("BookName3");
